...
void draw_logotext(){
    int x = 27;
    int y = 200;
    tft_draw_line(x, y, x+42, y, 0x001F);
    ...
    tft_draw_line(x+140, y+36, x+140, y+64, 0x001F);
    tft_draw_line(x+115, y+64, x+140, y+64, 0x001F);
    tft_draw_line(x+115, y+46, x+115, y+64, 0x001F);
